...
class RentHomeItemsScreen extends StatefulWidget {
  const RentHomeItemsScreen({Key? key}) : super(key: key);

  @override
  State<RentHomeItemsScreen> createState() => _RentHomeItemsScreenState();
}

class _RentHomeItemsScreenState extends State<RentHomeItemsScreen> {
