...
class SaleApartmentItemsScreen extends StatefulWidget {
  const SaleApartmentItemsScreen({Key? key}) : super(key: key);

  @override
  State<SaleApartmentItemsScreen> createState() =>
      _SaleApartmentItemsScreenState();
}

class _SaleApartmentItemsScreenState extends State<SaleApartmentItemsScreen> {
