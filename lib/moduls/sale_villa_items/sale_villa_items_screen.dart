...
class SaleVillaItemsScreen extends StatefulWidget {
  const SaleVillaItemsScreen({Key? key}) : super(key: key);

  @override
  State<SaleVillaItemsScreen> createState() => _SaleVillaItemsScreenState();
}

class _SaleVillaItemsScreenState extends State<SaleVillaItemsScreen> {
